...
public class GoodInfo {
    ...
    public void setMinGroupPrice(int minGroupPrice) {
    ...
    public void setCouponTotalQuantity(int couponTotalQuantity) {
    ...
    public void setCouponRemainQuantity(int couponRemainQuantity) {
    ...
    public void setAvgDesc(int avgDesc) {
    ...
    public void setAvgLgst(int avgLgst) {
    ...
    public void setAvgServ(int avgServ) {
